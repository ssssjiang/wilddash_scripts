...
def pano2sem_main(argv=sys.argv[1:]):
    ...
    cnt_success = panoptic2segm(json_path=args.json_path, outp_dir_sem=args.outp_dir_sem,
                                outp_dir_inst=args.outp_dir_inst, label_png_dir=args.label_png_dir, tqdm_vers=tqdm_vers)
    if not args.silent:
